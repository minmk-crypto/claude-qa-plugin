# gb-tf: QA Automation Skills for Claude Code

Global Beauty TF의 웹 QA 자동화 스킬셋.
...
cp -r claude-qa-plugin/skills/* .claude/skills/
```

그다음 Claude Code에서 `/mcp` → Playwright 연결 확인 후 `/qa` 실행.
